...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start px-24">
      {/* <form action={myAction} className='flex flex-col gap-2 '>
      <Input type="text" name="title" placeholder='' />
      <Input type="text" name="price" placeholder='podaj cenę artykułu' />
      <Button variant="default" type="submit">Dodaj product</Button>
    </form> */}
  ...
  {productsStore.map(el=>
    <TableRow key={el.id} className='border-2 border-slate-600'>
